...
declare global {
  ...
  const apiAction: typeof import('./resources/js/utils/api.js')['apiAction']
  const apiCall: typeof import('./resources/js/utils/api.js')['apiCall']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly apiAction: UnwrapRef<typeof import('./resources/js/utils/api.js')['apiAction']>
